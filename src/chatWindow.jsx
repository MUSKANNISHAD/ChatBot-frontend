...
function ChatWindow() {
    ...
    const logOut = async () => {
        ...
        const logout = await fetch("http://ec2-13-60-211-68.eu-north-1.compute.amazonaws.com:5000/logout", {
            method: "DELETE",
            headers: {
                "Content-Type": "application/json",
    ...
    const signup = async (e) => {
        ...
        const response = await fetch("http://ec2-13-60-211-68.eu-north-1.compute.amazonaws.com:5000/thread/signUp", {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
    ...
    const login = async (e) => {
        ...
        const loginUser = await fetch("http://ec2-13-60-211-68.eu-north-1.compute.amazonaws.com:5000/thread/login", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
            },

...
function ChatWindow({ setShowSidebar }) {
    ...
    const getReply = async () => {
        ...
        const response = await fetch("https://56.228.49.72:5000/chat", {
            method: "POST",
            headers: {
    ...
    const logOut = async () => {
        ...
        const logout = await fetch("https://56.228.49.72:5000/logout", {
            method: "DELETE",
            headers: {
                "Content-Type": "application/json",
    ...
    const signup = async (e) => {
        ...
        const response = await fetch("https://56.228.49.72:5000/thread/signUp", {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
    ...
    const login = async (e) => {
        ...
        const loginUser = await fetch("https://56.228.49.72:5000/thread/login", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
            },

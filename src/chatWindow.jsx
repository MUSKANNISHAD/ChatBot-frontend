...
function ChatWindow({ setShowSidebar }) {
    ...
    const getReply = async () => {
        ...
        const response = await fetch("https://stayhub-chat.duckdns.org:5000/chat", {
            method: "POST",
            headers: {
    ...
    const signup = async (e) => {
        ...
        const response = await fetch("https://stayhub-chat.duckdns.org:5000/thread/signUp", {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
    ...
    const login = async (e) => {
        ...
        const loginUser = await fetch("https://stayhub-chat.duckdns.org:5000/thread/login", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
            },
